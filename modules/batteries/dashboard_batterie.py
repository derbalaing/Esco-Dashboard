...
def show_dashboard_batterie():

    st.title("🔌 Dashboard Grid...")
    st.warning("VERSION TEST DASHBOARD GRID - MODIFICATION OK")
    ...
    active_sites = len(
        df[df["status"].astype(str).str.upper() == "ACTIVE"]
    )
    ...
    if df_fuel_daily.empty:
        ...
        # Filtre date sur les résultats KPI
